...
_THEME_PATTERNS: list[tuple[re.Pattern, str]] = [
    ...
    (re.compile(r"\bsuper.?pmi\b", re.I), "super-pmi"),
    ...
    (re.compile(r"\bcall.?conv|calling.?convention", re.I), "calling-convention"),
    ...
    (re.compile(r"\bintrinsic|avx\b|sse[0-9]?\b|neon\b|sve\b|bmi[0-9]?\b|fma\b|popcnt|lzcnt|tzcnt|pclmulqdq|aes\b|crc32|sha\b|AdvSimd|Arm\.", re.I), "hardware-intrinsics"),
    ...
    (re.compile(r"\bjit.?dump|spmi.?dump|disasm", re.I), "debug-dumps"),
    ...
    (re.compile(r"\bflowgraph|flow.?graph", re.I), "flowgraph"),
    ...
    (re.compile(r"\baddress.?mode", re.I), "addressing-modes"),
